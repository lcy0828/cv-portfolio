...
func initializeData() error {
	...
	_, err = DB.Exec(`
		...
		VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
		"张三", "云原生运维工程师", "https://picsum.photos/150/150", "zhangsan@example.com", "138-1234-5678", "北京",
	...
	projects := []map[string]interface{}{
		{
			"title": "企业级微服务容器化迁移", "category": "云原生迁移", "description": "将传统单体应用拆分为微服务架构，并迁移至Kubernetes平台，提升系统弹性和可扩展性。", "image": "https://picsum.photos/800/600?random=1",
			"demo_link":         "#",
			"repo_link":         "#",
		...
		{
			"title": "多云环境自动化运维平台", "category": "自动化部署", "description": "构建了一套跨多云平台的自动化运维系统，实现资源统一管理和应用自动部署。", "image": "https://picsum.photos/800/600?random=2",
			"demo_link":         "#",
			"repo_link":         "#",
